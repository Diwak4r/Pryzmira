            ...
            <div className="wide-container pb-20 pt-6 md:pt-10">
                ...
                {gen.voiceInsights && (
                    <div className="mt-3">
                        <button
                            ...
                            className="flex w-full items-center justify-between rounded-md border border-border bg-card px-3 py-2.5 text-left text-xs font-medium text-muted-foreground hover:text-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary"
                        >
                            Voice insights
                ...
                <div className="mt-4 flex flex-wrap items-center gap-1.5">
                    {QUICK_REFINE.map((action) => (
                        <button
                            ...
                            disabled={isPending}
                            className="rounded-md border border-border bg-card px-2.5 py-2 text-xs text-muted-foreground hover:border-primary/30 hover:text-foreground disabled:opacity-40 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary"
                        >
                            {action.replace('.', '')}
                        </button>
                    ))}
                    <button
                        ...
                        disabled={isPending}
                        className="flex items-center gap-1 rounded-md border border-border bg-card px-2.5 py-2 text-xs text-muted-foreground hover:border-primary/30 hover:text-foreground disabled:opacity-40 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary"
                    >
                            ...
                            <div className="max-h-64 overflow-y-auto rounded-b-md border border-t-0 border-border">
                                {history.map((entry) => (
                                    <button
                                        ...
                                        className={`block w-full border-b border-border px-3 py-2.5 text-left last:border-b-0 hover:bg-accent focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary focus-visible:ring-inset ${
                ...
                {error && (
                    <div className="mt-4 flex items-start gap-2 rounded-md border border-destructive/30 bg-destructive/5 px-3 py-2.5 text-sm text-destructive">
                        ...
                        <button type="button" onClick={() => setError('')} className="shrink-0 rounded-sm text-destructive/60 hover:text-destructive focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-destructive" aria-label="Dismiss error">
