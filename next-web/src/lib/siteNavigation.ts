...
const routeMeta: Record<string, SiteNavItem> = {
    '/': {
        ...
        shortLabel: 'Home',
        eyebrow: 'Entry',
        title: 'Start with an AI workspace, not a pile of links.',
        summary: 'Choose your AI goal and let Pryzmira turn it into a working weekly brief.',
        focus: 'Home should convert curiosity into a saved workspace.',
        shell: 'home',
        showNewsletter: true,
    ...
    '/desk': {
        ...
        title: 'Your AI workspace, brief, and supporting stack.',
        summary: 'This is the main surface where Pryzmira should tell you what to do next.',
