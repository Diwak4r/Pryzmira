            ...
            try {
                const response = await fetch('https://api.resend.com/emails', {
                    ...
                    body: JSON.stringify({
                        ...
                        to: [normalizedEmail],
                        subject: 'Welcome to Pryzmira Weekly Workspace Briefs',
                        html: `
                            <!DOCTYPE html>
                            <html>
                            <head>
                            ...
                            <body style="margin:0;padding:0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif;background-color:#0a0a0a;">
                                <div style="max-width:600px;margin:0 auto;padding:40px 20px;">
                                    <div style="text-align:center;margin-bottom:40px;">
                                        ...
                                        <p style="color:#888;font-size:14px;margin-top:8px;">AI workspace platform</p>
                                    </div>
                                    <div style="background:linear-gradient(135deg,#1a1a2e 0%,#16213e 100%);border-radius:16px;padding:40px;border:1px solid #333;">
                                        <h2 style="color:#ffffff;font-size:24px;margin:0 0 20px 0;">Your weekly brief starts here.</h2>
                                        <p style="color:#cccccc;font-size:16px;line-height:1.6;margin:0 0 20px 0;">You are now on the list for Pryzmira's weekly workspace brief: a concise note about better AI direction, better tools, and better next steps.</p>
                                        <p style="color:#cccccc;font-size:16px;line-height:1.6;margin:0 0 24px 0;">What to expect:</p>
                                        <div style="margin-bottom:30px;">
                                            <div style="display:flex;align-items:center;margin-bottom:16px;">
                                                <span style="color:#00d4ff;font-size:20px;margin-right:12px;">*</span>
                                                <span style="color:#ffffff;font-size:15px;">One sharper AI focus for the week</span>
                                            </div>
                                            <div style="display:flex;align-items:center;margin-bottom:16px;">
                                                <span style="color:#00d4ff;font-size:20px;margin-right:12px;">*</span>
                                                <span style="color:#ffffff;font-size:15px;">Useful tools and workflows worth testing</span>
                                            </div>
                                            <div style="display:flex;align-items:center;margin-bottom:16px;">
                                                <span style="color:#00d4ff;font-size:20px;margin-right:12px;">*</span>
                                                <span style="color:#ffffff;font-size:15px;">Learning depth that actually supports execution</span>
                                            </div>
                                            <div style="display:flex;align-items:center;margin-bottom:16px;">
                                                <span style="color:#00d4ff;font-size:20px;margin-right:12px;">*</span>
                                                <span style="color:#ffffff;font-size:15px;">A cleaner route back into your workspace</span>
                                            </div>
                                        </div>
                                        <a href="${siteUrl}" style="display:inline-block;background:linear-gradient(135deg,#667eea 0%,#764ba2 100%);color:#ffffff;text-decoration:none;padding:14px 32px;border-radius:8px;font-weight:600;font-size:16px;">Open Pryzmira</a>
                                    </div>
